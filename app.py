# NESME v1.0.2 - Full Streamlit Emotional Memory Engine (Streamlit Cloud Safe, Unified Imports)
...
# Load pre-trained emotion model and tokenizer outside cache (safe for Streamlit Cloud)
model_name = "j-hartmann/emotion-english-distilroberta-base"
st.write("Loading models... (This may take a few seconds on first run)")
